 ...
 * version: 1.0
 * 
 * This file reads an argument from the user, calls the functions of
 * the ManWolf class, and prints the result to the command line.
 */
 ...
 * the user whether or not the solution is correct.
 */
